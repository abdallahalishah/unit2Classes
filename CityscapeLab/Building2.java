...
public class Building2
{
     ...
     */
    public Building2(int x, int y, boolean check)
    {
        this.height = y;
        this.width = x;
        this.dayNight = check;
    ...
    public void draw(Graphics2D g2)
    {
        ...
        Rectangle back1 = new Rectangle(this.width, this.height-492, 152, 292);
        Rectangle main1 = new Rectangle((int)(back1.getX())+ 2,this.height-490, 148, 288);
        ...
        if (dayNight==true)
        {
            Color darkRed = new Color(30,0,0);
            g2.setColor(darkRed);g2.fill(main1);g2.draw(main1);
        }
        if (dayNight==false)
        {
            Color red = new Color(70,0,0);
            g2.setColor(red);g2.fill(main1);g2.draw(main1);
        }
