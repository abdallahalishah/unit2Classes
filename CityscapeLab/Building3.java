...
public class Building3
{
     ...
     */
    public Building3(int x, int y, boolean check)
    {
        this.height = y;
        this.width = x;
        this.dayNight = check;
    ...
    public void draw(Graphics2D g2)
    {
        ...
        Rectangle antennaBack = new Rectangle(main1X+main1Width/4,main1Y-150,6,150);
        Rectangle antenna = new Rectangle(main1X+main1Width/4+1,main1Y-149,4,146);
