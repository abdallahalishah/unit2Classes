...
public class Building4
{
    ...
    /**
     * Constructor for objects of class Building4
     * 
     ...
     */
    public Building4(int x, int y, boolean check)
    {
        this.height = y;
        this.width = x;
        this.dayNight = check;
    ...
    public void draw(Graphics2D g2)
    {
        ...
        Rectangle back1 = new Rectangle(this.width, this.height-(600-31-5), 152, 400-31-5);
        ...
        if (dayNight==true)
        {
            Color blue = new Color(11,8,12);
            g2.setColor(blue);g2.fill(main1);g2.draw(main1);
        }
        if (dayNight==false)
        {
            Color blue = new Color(111,48,52);
            g2.setColor(blue);g2.fill(main1);g2.draw(main1);
        }
