...
public class Building6
{
    ...
    /**
     * Constructor for objects of class Building6
     * 
     ...
     */
    public Building6(int x, int y, boolean check)
    {
        this.height = y;
        this.width = x;
        this.dayNight = check;
    ...
    public void draw(Graphics2D g2)
    {
        ...
        Rectangle back1 = new Rectangle(this.width, this.height-(600-31*2-5*2), 152, 400-31*2-5*2);
        Rectangle main1 = new Rectangle((int)(back1.getX())+ 2,this.height-(598-31*2-5*2), 148, 396-31*2-5*2);
