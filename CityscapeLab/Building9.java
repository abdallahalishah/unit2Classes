...
public class Building9
{
    ...
    /**
     * Constructor for objects of class Building9
     * 
     ...
     */
    public Building9(int x, int y, boolean check)
    {
        this.height = y;
        this.width = x;
        this.dayNight = check;
    ...
    public void draw(Graphics2D g2)
    {
        ...
        Rectangle back1 = new Rectangle(this.width, this.height-(600-31*8-5*8), 172, 400-31*8-5*8);
        Rectangle main1 = new Rectangle((int)(back1.getX())+ 2,this.height-(598-31*8-5*8), 168, 396-31*8-5*8);
        ...
        if (dayNight==true)
        {
            Color blue = new Color(0,0,20);
            g2.setColor(blue);g2.fill(main1);g2.draw(main1);
        }
        if (dayNight==false)
        {
            Color blue = new Color(0,0,70);
            g2.setColor(blue);g2.fill(main1);g2.draw(main1);
        }
