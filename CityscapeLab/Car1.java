...
/**
 * Class that creates a car heading right with varying colors.
 * 
...
public class Car1
{
    ...
    public void draw(Graphics2D g2,int num, int numColor)
    {
        ...
        Rectangle body = new Rectangle(num-200,this.height-50,80,20);
        ...
        int topXPoly[] = {bodyX+bodyW/3,bodyX+(bodyW/6),bodyX+(bodyW/6)*5,bodyX+(bodyW/3)*2};
        int topYPoly[] = {bodyY-15,bodyY,bodyY,bodyY-15};
        
        /* the x and y coordinates for front of the car */
        int frontXPoly[] = {bodyX+bodyW,bodyX+bodyW,bodyX+bodyW+30};
        int frontYPoly[] = {bodyY,bodyY+bodyH,bodyY+bodyH};
        
        /* the x and y coordinates for back of the car */
        int backXPoly[] = {bodyX,bodyX,bodyX-10};
        ...
        int exhaustX[] = {bodyX-5,bodyX-15,bodyX-5,bodyX};
        ...
        Polygon carTop = new Polygon(topXPoly, topYPoly, 4);
        ...
        Point2D.Double frontTop = new Point2D.Double(bodyX+bodyW-5,bodyY);
        Point2D.Double frontBottom = new Point2D.Double(bodyX+bodyW+5,bodyY+bodyH);
        ...
        if (numColor==0){g2.setColor(Color.RED);g2.fill(body);g2.draw(body);}
        if (numColor==1){g2.setColor(Color.BLUE);g2.fill(body);g2.draw(body);}
        if (numColor==2){g2.setColor(Color.YELLOW);g2.fill(body);g2.draw(body);}
        if (numColor==3){g2.setColor(Color.GREEN);g2.fill(body);g2.draw(body);}
        ...
        if (numColor==0){g2.setColor(Color.RED);g2.fill(midCut);g2.draw(midCut);}
        if (numColor==1){g2.setColor(Color.BLUE);g2.fill(midCut);g2.draw(midCut);}
        if (numColor==2){g2.setColor(Color.YELLOW);g2.fill(midCut);g2.draw(midCut);}
        if (numColor==3){g2.setColor(Color.GREEN);g2.fill(midCut);g2.draw(midCut);}
